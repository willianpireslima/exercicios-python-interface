...
def par_impar():
    try:
        ...
        if   (num1 > num2 and num1 > num3) : soma = num2 + num3
        elif (num2 > num1 and num2 > num3) : soma = num1 + num3
        elif (num3 > num1 and num3 > num2) : soma = num2 + num1

        label_resultado.configure(text=f"{soma}")
    except ValueError:
